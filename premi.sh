...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO ROSI STORE PREMIUM SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}ROSI STORE <® ${NC}${YELLOW}(${NC}${green}V 3.0${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/rasi1982/sc-vvip/main/"
...
clear
    print_install "Core Xray 1.8.25 Latest Version"
...
[Unit]
Description=UDP Custom by Hamba Allah
